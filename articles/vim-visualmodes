...
# ビジュアル 行ビジュアル 矩形ビジュアル

今迄身体に染み付いてて気付かなかったんですが
よくよく考えると`v`、`V`、`<C-v>`って使いわけるの面倒くさくないですか
ぜんぶ`v`でいいかんじによろしくしたい
思考の速度を超えたい思考したくない(怠惰)

# ビジュアル(文字単位)での行移動

文字単位のビジュアルのときって上下にカーソルを動かすことって少ないと思うんです
逆に行ビジュアルのときは複数行を選択したいときです(単一行への操作ならビジュアルを使わなくてよい)
それならば、文字単位のビジュアルのとき行移動したときは行ビジュアルに移行させちゃいましょう
...
1. ビジュアル→行ビジュアル→矩形ビジュアル→ノーマルモード

ビジュアルモード中に`v`, `V`, `<C-v>`で切り替えられますが
これも`v`だけですませたいところです
